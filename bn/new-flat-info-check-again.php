...
if($_SESSION['new-flat-info'][$rand]['lift'] == 'Yes'){
...
if($_SESSION['new-flat-info'][$rand]['parking_facility'] == 'Yes'){
...
<body onload="startTime()">
	<div class="topnav">
        ...
        <div class="topnav-right">
            ...
            <a href="logout?cbp=new-flat-info-check-again">লগ আউট</a>
        </div>
    </div>
        	...
        	<tr>
                ...
                <td id="everythingMiddle">
                    ...
                    <table id="advertisementDetailsTable">
                            ...
                            <td colspan="2" id="adDetailsTableFirstColspan">
                                <table id="adDetailsTableLeft">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($_SESSION['new-flat-info'][$rand]['rent'] == 1){ echo 'ভাড়া'; }else if($_SESSION['new-flat-info'][$rand]['sale'] == 1){ echo 'বিক্রয়'; } ?></td>
                                    </tr>
                                    <tr>
                        ...
                        if($_SESSION['new-flat-info'][$rand]['sale'] == 1){
                            ...
                            <tr>
                                ...
                                <td colspan="3"><?php echo $security_money;  if($security_money != ''){ ?> <a id="fullLengthViewLink" onClick="popUp('securityMoneyDiv')">দেখান</a><div id="securityMoneyDiv" class="fullLengthViewDiv" style="display:none"><?php echo 'বুকিং মূল্য: ' . $security_money_original; ?><button id="closeButton" onClick="popDown('securityMoneyDiv')">বন্ধ</button></div><?php } ?></td>
                            </tr>
                            <?php
                            ...
                            <tr>
                                ...
                                <td colspan="3"><?php echo $security_money;  if($security_money != ''){ ?> <a id="fullLengthViewLink" onClick="popUp('securityMoneyDiv')">দেখান</a><div id="securityMoneyDiv" class="fullLengthViewDiv" style="display:none"><?php echo 'জমা মূল্য: ' . $security_money_original; ?><button id="closeButton" onClick="popDown('securityMoneyDiv')">বন্ধ</button></div><?php } ?></td>
                            </tr>
                            <?php
                    ...
                    <form action="" method="post">
                        ...
                        <div id="backDiv"><a id="backLink" href="<?php echo $urlBackPage; ?>">ফ্ল্যাট-এর তথ্য এ ফিরে চলুন</a></div>
                    </form>
                </td>

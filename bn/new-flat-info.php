...
$_SESSION['comebackUrl']['new-flat-info'] = $pathUrl;
...
<head>
    <meta charset="utf-8">
    <title>কী খুঁজি - ফ্ল্যাট-এর তথ্য</title>
    ...
    <link rel="stylesheet" href="css/new-flat-info.css">

	<script src="js/clock.js"></script>
	<script src="js/jquery.js"></script>
    <script src="js/jquery_ui.js"></script>
    <script src="js/new-flat-info.js"></script>
</head>

<?php

$urlNextPage = 'new-flat-info-check-again';
$urlBackPage = 'mark?content=flat';
...
if(isset($_SESSION['new-flat-info-error'][$rand])){
	
	$sale = $_SESSION['new-flat-info-error'][$rand]['sale'];
	$rent = $_SESSION['new-flat-info-error'][$rand]['rent'];
	$mess = $_SESSION['new-flat-info-error'][$rand]['mess'];
	$available_from = $_SESSION['new-flat-info-error'][$rand]['available_from'];
	$male = $_SESSION['new-flat-info-error'][$rand]['male'];
	$female = $_SESSION['new-flat-info-error'][$rand]['female'];
	$family = $_SESSION['new-flat-info-error'][$rand]['family'];
	$max_people = $_SESSION['new-flat-info-error'][$rand]['max_people'];
	$rental_price = $_SESSION['new-flat-info-error'][$rand]['rental_price'];
	$rental_price_nego = $_SESSION['new-flat-info-error'][$rand]['rental_price_nego'];
	$security_money = $_SESSION['new-flat-info-error'][$rand]['security_money'];
	$security_money_nego = $_SESSION['new-flat-info-error'][$rand]['security_money_nego'];
	$full_address = $_SESSION['new-flat-info-error'][$rand]['full_address'];
	$contact_no_option = $_SESSION['new-flat-info-error'][$rand]['contact_no_option'];
	$contact_no = $_SESSION['new-flat-info-error'][$rand]['contact_no'];
	$contact_email = $_SESSION['new-flat-info-error'][$rand]['contact_email'];
	$flat_no = $_SESSION['new-flat-info-error'][$rand]['flat_no'];
	$floor = $_SESSION['new-flat-info-error'][$rand]['floorBengali'];
	$size_of_flat = $_SESSION['new-flat-info-error'][$rand]['size_of_flat'];
	$number_of_rooms = $_SESSION['new-flat-info-error'][$rand]['number_of_rooms'];
	$number_of_washrooms = $_SESSION['new-flat-info-error'][$rand]['number_of_washrooms'];
	$number_of_balconies = $_SESSION['new-flat-info-error'][$rand]['number_of_balconies'];
	$total_floors = $_SESSION['new-flat-info-error'][$rand]['total_floorsBengali'];
	$lift = $_SESSION['new-flat-info-error'][$rand]['lift'];
	$parking_facility = $_SESSION['new-flat-info-error'][$rand]['parking_facility'];
	$other_description = $_SESSION['new-flat-info-error'][$rand]['other_description'];
...
<body onload="startTime()">
	<div class="topnav">
        ...
        <div class="topnav-right">
            ...
            <a href="logout?cbp=new-flat-info">লগ আউট</a>
        </div>
    </div>
    ...
    <div id="nonFooter">
        <form action="" method="post">
            <table id="flatInfo">
                <tr id="heading"><td colspan="2">ফ্ল্যাটটি সম্পর্কে কিছু তথ্য লিখুন</td></tr>
                <tr>
                ...
                <tr id="availableFor" <?php if($sale == 1){ ?>style="display:none"<?php } ?> >
                ...
                <tr id="maxNumPeople" <?php if($mess == 0){ ?>style="display:none"<?php } ?> >
                    <td>সর্বাধিক জনসংখ্যা (যদি মেস হিসেবে ব্যবহার করা হয়)<input type="button" id="button_maxppl" value="?"><span id="sidenote_maxppl">যদি সিঙ্গেল ব্যক্তিরা ফ্ল্যাটটি ভাড়া নেয়, তাহলে সর্বোচ্চ যতজন থাকতে পারবে</span></td> <td><input type="text" name="max-people-in-mess" <?php if(isset($max_people)){ ?>value="<?php echo $max_people; ?>"<?php } ?> pattern="^[0-9]+"> <span id="mx-ppl" class="sidenote">একটি সঠিক সংখ্যা ব্যবহার করুন</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><span id="securityMoneyName" <?php if($sale == 1){ ?>style="display:none"<?php } ?> >জমা মূল্য<input type="button" id="button_scmoney" value="?"><span id="sidenote_scmoney">ফ্ল্যাটে ওঠার আগে যে পরিমাণ টাকা দিতে হবে, যা ফ্ল্যাট ছাড়ার পূর্ব পর্যন্ত জমা থাকবে ।</span></span><span id="bookingMoneyName" <?php if($rent == 1){ ?>style="display:none"<?php } ?> >বুকিং মূল্য<input type="button" id="button_scmoney" value="?"><span id="sidenote_scmoney">কেনার প্রক্রিয়া শুরু করার জন্য শুরুতেই যে পরিমাণ অর্থ দিতে হবে ।</span></span></td> <td><input type="text" name="security-money" <?php if(isset($security_money)){ ?>value="<?php echo $security_money; ?>"<?php } ?> pattern="^[0-9.]+"> টাকা <input type="checkbox" name="security-money-checkbox" id="security-money-checkbox" <?php if($security_money_nego == 1){ echo 'checked'; } ?>> আলোচনাসাপেক্ষ <span id="sc" class="sidenote">একটি সঠিক পরিমাণ উল্লেখ করুন</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>ঘরের সংখ্যা</td> <td><input type="text" name="number-of-rooms" <?php if(isset($number_of_rooms)){ ?>value="<?php echo $number_of_rooms; ?>"<?php } ?> pattern="^[0-9]+"> <span id="num-rm" class="sidenote">একটি সঠিক সংখ্যা লিখুন</span></td>
                </tr>
                <tr>
                    <td>বাথরুমের সংখ্যা</td> <td><input type="text" name="number-of-washrooms" <?php if(isset($number_of_washrooms)){ ?>value="<?php echo $number_of_washrooms; ?>"<?php } ?> pattern="^[0-9]+"> <span id="num-wsrm" class="sidenote">একটি সঠিক সংখ্যা লিখুন</span></td>
                </tr>
                <tr>
                    <td>বারান্দার সংখ্যা</td> <td><input type="text" name="number-of-balconies" <?php if(isset($number_of_balconies)){ ?>value="<?php echo $number_of_balconies; ?>"<?php } ?> pattern="^[0-9]+"> <span id="num-bal" class="sidenote">একটি সঠিক সংখ্যা লিখুন</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>অন্যান্য বর্ণনা</td> <td><textarea name="other-description" placeholder="যেকোনো অতিরিক্ত তথ্য এখানে লিখতে পারেন । যেমনঃ ফ্ল্যাটটির দক্ষিণ দিকে একটি বারান্দা আছে । একটি বাথরুমে কমোড আর বাথটাব আছে........, ইত্যাদি । অতিরিক্ত ফোন নম্বরঃ 01..........., 02........... অতিরিক্ত ইমেইলঃ no-reply@kikhuji.com"><?php if(isset($other_description)){ echo $other_description; } ?></textarea> <span id="oth-des" class="sidenote">সঠিক চিহ্ন বা সংখ্যা ব্যবহার করুন</span></td>
                </tr>
                <tr>
                	<td>ছবি</td>
                    <td id="photos">
...
if(isset($_POST['submit'])){
	...
	$errorFound = 0;
	$error_link = 'new-flat-info?key=' . $rand;
	...
	$_SESSION['new-flat-info-error'][$rand]['sale'] = $sale;
	$_SESSION['new-flat-info-error'][$rand]['rent'] = $rent;
	
	$available_from = $_POST['available_from'];
	$_SESSION['new-flat-info-error'][$rand]['available_from'] = $available_from;
	...
	$_SESSION['new-flat-info-error'][$rand]['male'] = $male;
	...
	$_SESSION['new-flat-info-error'][$rand]['female'] = $female;
	...
	$_SESSION['new-flat-info-error'][$rand]['family'] = $family;
	...
	$_SESSION['new-flat-info-error'][$rand]['mess'] = $mess;
	...
	if($mess == 1){
		...
		$_SESSION['new-flat-info-error'][$rand]['max_people'] = $max_people;
		...
		$_SESSION['new-flat-info-error'][$rand]['max_people'] = '';
		
	}
	
	$rental_price = $_POST['rental-price'];
	$_SESSION['new-flat-info-error'][$rand]['rental_price'] = $rental_price;
	...
	$_SESSION['new-flat-info-error'][$rand]['rental_price_nego'] = $rental_price_nego;
	
	$security_money = $_POST['security-money'];
	$_SESSION['new-flat-info-error'][$rand]['security_money'] = $security_money;
	...
	$_SESSION['new-flat-info-error'][$rand]['security_money_nego'] = $security_money_nego;
	
	$full_address = $_POST['full-address'];
	$_SESSION['new-flat-info-error'][$rand]['full_address'] = $full_address;
	...
	$_SESSION['new-flat-info-error'][$rand]['contact_no'] = $contact_no;
	$contact_no_option = $_POST['contact-no-option'];
	$_SESSION['new-flat-info-error'][$rand]['contact_no_option'] = $contact_no_option;
	...
	$_SESSION['new-flat-info-error'][$rand]['contact_email'] = $contact_email;
	...
	$_SESSION['new-flat-info-error'][$rand]['flat_no'] = $flat_no;
	...
	$floor = $_POST['floor'];
	$_SESSION['new-flat-info-error'][$rand]['floor'] = $floor;
	$_SESSION['new-flat-info-error'][$rand]['floorBengali'] = $floor;
	...
	if($floor != ''){
		...
		if(!preg_match("/^[0-9-]+$/",$floor)){
			...
			$_SESSION['new-flat-info-error'][$rand]['floor'] = $floor - 1;
	...
	$_SESSION['new-flat-info-error'][$rand]['size_of_flat'] = $size_of_flat;
	...
	$_SESSION['new-flat-info-error'][$rand]['number_of_rooms'] = $number_of_rooms;
	...
	$_SESSION['new-flat-info-error'][$rand]['number_of_washrooms'] = $number_of_washrooms;
	...
	$_SESSION['new-flat-info-error'][$rand]['number_of_balconies'] = $number_of_balconies;
	...
	$_SESSION['new-flat-info-error'][$rand]['total_floors'] = $total_floors;
	$_SESSION['new-flat-info-error'][$rand]['total_floorsBengali'] = $total_floors;
	...
	if($total_floors != ''){
		...
		if(!preg_match("/^[0-9-]+$/",$total_floors)){
			...
			$_SESSION['new-flat-info-error'][$rand]['total_floors'] = $total_floors - 1;
	...
	$_SESSION['new-flat-info-error'][$rand]['lift'] = $lift;
	...
	$_SESSION['new-flat-info-error'][$rand]['parking_facility'] = $parking_facility;
	
	$other_description = $_POST['other-description'];
	$_SESSION['new-flat-info-error'][$rand]['other_description'] = $other_description;
	...
	$_SESSION['new-flat-info'][$rand]['sale'] = $sale;
	$_SESSION['new-flat-info'][$rand]['rent'] = $rent;
	$_SESSION['new-flat-info'][$rand]['mess'] = $mess;
	$_SESSION['new-flat-info'][$rand]['available_from'] = $available_from;
	$_SESSION['new-flat-info'][$rand]['male'] = $male;
	$_SESSION['new-flat-info'][$rand]['female'] = $female;
	$_SESSION['new-flat-info'][$rand]['family'] = $family;
	$_SESSION['new-flat-info'][$rand]['max_people'] = $max_people;
	$_SESSION['new-flat-info'][$rand]['rental_price'] = $rental_price;
	$_SESSION['new-flat-info'][$rand]['rental_price_nego'] = $rental_price_nego;
	$_SESSION['new-flat-info'][$rand]['security_money'] = $security_money;
	$_SESSION['new-flat-info'][$rand]['security_money_nego'] = $security_money_nego;
	$_SESSION['new-flat-info'][$rand]['full_address'] = $full_address;
	$_SESSION['new-flat-info'][$rand]['contact_no'] = $contact_no;
	$_SESSION['new-flat-info'][$rand]['contact_email'] = $contact_email;
	$_SESSION['new-flat-info'][$rand]['flat_no'] = $flat_no;
	$_SESSION['new-flat-info'][$rand]['floor'] = $_SESSION['new-flat-info-error'][$rand]['floor'];
	$_SESSION['new-flat-info'][$rand]['floorBengali'] = $floor;
	$_SESSION['new-flat-info'][$rand]['size_of_flat'] = $size_of_flat;
	$_SESSION['new-flat-info'][$rand]['number_of_rooms'] = $number_of_rooms;
	$_SESSION['new-flat-info'][$rand]['number_of_washrooms'] = $number_of_washrooms;
	$_SESSION['new-flat-info'][$rand]['number_of_balconies'] = $number_of_balconies;
	$_SESSION['new-flat-info'][$rand]['total_floors'] = $_SESSION['new-flat-info-error'][$rand]['total_floors'];
	$_SESSION['new-flat-info'][$rand]['total_floorsBengali'] = $total_floors;
	$_SESSION['new-flat-info'][$rand]['lift'] = $lift;
	$_SESSION['new-flat-info'][$rand]['parking_facility'] = $parking_facility;
	$_SESSION['new-flat-info'][$rand]['other_description'] = $other_description;

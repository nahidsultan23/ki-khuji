...
if($_SESSION['new-mess-info'][$rand]['lift'] == 'Yes'){
...
<body onload="startTime()">
	<div class="topnav">
        ...
        <div class="topnav-right">
            ...
            <a href="logout?cbp=new-mess-info-check-again">লগ আউট</a>
        </div>
    </div>
        	...
        	<tr>
                ...
                <td id="everythingMiddle">
                    ...
                    <form action="" method="post">
                        ...
                        <div id="backDiv"><a id="backLink" href="<?php echo $urlBackPage; ?>">মেস-এর তথ্য এ ফিরে চলুন</a></div>
                    </form>
                </td>

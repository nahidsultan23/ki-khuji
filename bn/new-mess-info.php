...
$_SESSION['comebackUrl']['new-mess-info'] = $pathUrl;

if(!isset($_SESSION['id'])){
	
	header('Location:login?er=login-need&cbp=new-mess-info');
	exit;
...
<head>
    <meta charset="utf-8">
    <title>কী খুঁজি - মেস-এর তথ্য</title>
    ...
    <link rel="stylesheet" href="css/new-mess-info.css">

	<script src="js/clock.js"></script>
	<script src="js/jquery.js"></script>
    <script src="js/jquery_ui.js"></script>
    <script src="js/new-mess-info.js"></script>
</head>

<?php

$urlNextPage = 'new-mess-info-check-again';
$urlBackPage = 'mark?content=mess';
...
if(isset($_SESSION['new-mess-info-error'][$rand])){

	$available_from = $_SESSION['new-mess-info-error'][$rand]['available_from'];
	$male = $_SESSION['new-mess-info-error'][$rand]['male'];
	$female = $_SESSION['new-mess-info-error'][$rand]['female'];
	$max_people = $_SESSION['new-mess-info-error'][$rand]['max_people'];
	$rental_price = $_SESSION['new-mess-info-error'][$rand]['rental_price'];
	$rental_price_nego = $_SESSION['new-mess-info-error'][$rand]['rental_price_nego'];
	$security_money = $_SESSION['new-mess-info-error'][$rand]['security_money'];
	$security_money_nego = $_SESSION['new-mess-info-error'][$rand]['security_money_nego'];
	$full_address = $_SESSION['new-mess-info-error'][$rand]['full_address'];
	$contact_no = $_SESSION['new-mess-info-error'][$rand]['contact_no'];
	$contact_email = $_SESSION['new-mess-info-error'][$rand]['contact_email'];
	$flat_no = $_SESSION['new-mess-info-error'][$rand]['flat_no'];
	$floor = $_SESSION['new-mess-info-error'][$rand]['floorBengali'];
	$size_of_flat = $_SESSION['new-mess-info-error'][$rand]['size_of_flat'];
	$size_of_room = $_SESSION['new-mess-info-error'][$rand]['size_of_room'];
	$number_of_rooms = $_SESSION['new-mess-info-error'][$rand]['number_of_rooms'];
	$number_of_washrooms = $_SESSION['new-mess-info-error'][$rand]['number_of_washrooms'];
	$washroom_attached = $_SESSION['new-mess-info-error'][$rand]['washroom_attached'];
	$number_of_balconies = $_SESSION['new-mess-info-error'][$rand]['number_of_balconies'];
	$balcony_attached = $_SESSION['new-mess-info-error'][$rand]['balcony_attached'];
	$total_floors = $_SESSION['new-mess-info-error'][$rand]['total_floorsBengali'];
	$lift = $_SESSION['new-mess-info-error'][$rand]['lift'];
	$other_description = $_SESSION['new-mess-info-error'][$rand]['other_description'];
...
<body onload="startTime()">
	<div class="topnav">
        ...
        <div class="topnav-right">
            ...
            <a href="logout?cbp=new-mess-info">লগ আউট</a>
        </div>
    </div>
    ...
    <div id="nonFooter">
        <form action="" method="post">
            <table id="messInfo">
                <tr id="heading"><td colspan="2">মেসটি সম্পর্কে কিছু তথ্য লিখুন</td></tr>
                <tr>
                ...
                <tr id="maxNumPeople">
                    <td>রুমে সর্বাধিক জনসংখ্যা<input type="button" id="button_maxppl" value="?"><span id="sidenote_maxppl">সর্বোচ্চ জনসংখ্যা যারা মেসের এই রুমটিতে থাকবে ।</span></td></td> <td><input type="text" name="max-people-in-mess" <?php if(isset($max_people)){ ?>value="<?php echo $max_people; ?>"<?php } ?> pattern="^[0-9]+"> <span id="mx-ppl" class="sidenote">একটি সঠিক সংখ্যা ব্যবহার করুন</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>জমা মূল্য<input type="button" id="button_scmoney" value="?"><span id="sidenote_scmoney">মেসে ওঠার আগে যে পরিমাণ টাকা দিতে হবে, যা মেস ছাড়ার পূর্ব পর্যন্ত জমা থাকবে ।</span></td> <td><input type="text" name="security-money" <?php if(isset($security_money)){ ?>value="<?php echo $security_money; ?>"<?php } ?> pattern="^[0-9.]+"> টাকা <input type="checkbox" name="security-money-checkbox" id="security-money-checkbox" <?php if($security_money_nego == 1){ echo 'checked'; } ?>> আলোচনাসাপেক্ষ <span id="sc" class="sidenote">একটি সঠিক পরিমাণ উল্লেখ করুন</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>ফ্ল্যাট নম্বর</td> <td><input type="text" name="flat-no" <?php if(isset($flat_no)){ ?>value="<?php echo $flat_no; ?>"<?php } ?> > <span id="flat" class="sidenote">সঠিক চিহ্ন বা সংখ্যা ব্যবহার করুন</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>রুমের আকার</td> <td><input type="text" name="room-size" <?php if(isset($size_of_room)){ ?>value="<?php echo $size_of_room; ?>"<?php } ?> pattern="^[0-9.]+"> বর্গফুট <span id="rm-sz" class="sidenote">একটি সঠিক আকার লিখুন</span></td>
                </tr>
                <tr>
                    <td>ফ্ল্যাটে ঘরের সংখ্যা</td> <td><input type="text" name="number-of-rooms" <?php if(isset($number_of_rooms)){ ?>value="<?php echo $number_of_rooms; ?>"<?php } ?> pattern="^[0-9]+"> <span id="num-rm" class="sidenote">একটি সঠিক সংখ্যা লিখুন</span></td>
                </tr>
                <tr>
                    <td>ফ্ল্যাটে বাথরুমের সংখ্যা</td> <td><input type="text" name="number-of-washrooms" <?php if(isset($number_of_washrooms)){ ?>value="<?php echo $number_of_washrooms; ?>"<?php } ?> pattern="^[0-9]+"> <span id="num-wsrm" class="sidenote">একটি সঠিক সংখ্যা লিখুন</span></td>
                </tr>
                <tr>
                    <td>এই রুমের সাথে কী এটাচড বাথরুম আছে?</td> <td><select name="washroom-attached">
                ...
                <tr>
                    <td>ফ্ল্যাটে বারান্দার সংখ্যা</td> <td><input type="text" name="number-of-balconies" <?php if(isset($number_of_balconies)){ ?>value="<?php echo $number_of_balconies; ?>"<?php } ?> pattern="^[0-9]+"> <span id="num-bal" class="sidenote">একটি সঠিক সংখ্যা লিখুন</span></td>
                </tr>
                <tr>
                    <td>এই রুমের সাথে কী এটাচড বারান্দা আছে?</td> <td><select name="balcony-attached">
                ...
                <tr>
                    <td>রুমটিতে যাবার জন্য কী কোনো লিফট আছে?</td> <td><select name="lift">
                            <option value="Yes" <?php if($lift == 'Yes'){ echo 'selected'; } ?> >হ্যাঁ</option>
                            <option value="No" <?php if($lift == 'No'){ echo 'selected'; } ?> >না</option>
                        </select></td>
                </tr>
                <tr>
                    <td>অন্যান্য বর্ণনা</td> <td><textarea name="other-description" placeholder="যেকোনো অতিরিক্ত তথ্য এখানে লিখতে পারেন । যেমনঃ রুমটি আলো-বাতাসপূর্ণ এবং প্রায় চারজন মানুষের থাকার জায়গা আছে । রুমে দুটি বড় বড় জানালা আছে........, ইত্যাদি । অতিরিক্ত ফোন নম্বরঃ 01..........., 02........... অতিরিক্ত ইমেইলঃ no-reply@kikhuji.com"><?php if(isset($other_description)){ echo $other_description; } ?></textarea> <span id="oth-des" class="sidenote">সঠিক চিহ্ন বা সংখ্যা ব্যবহার করুন</span></td>
                </tr>
                <tr>
                	<td>ছবি</td>
                    <td id="photos">
...
if(isset($_POST['submit'])){
	...
	$errorFound = 0;
	$error_link = 'new-mess-info?key=' . $rand;
	
	$available_from = $_POST['available_from'];
	$_SESSION['new-mess-info-error'][$rand]['available_from'] = $available_from;
	...
	$_SESSION['new-mess-info-error'][$rand]['male'] = $male;
	...
	$_SESSION['new-mess-info-error'][$rand]['female'] = $female;
	...
	$_SESSION['new-mess-info-error'][$rand]['max_people'] = $max_people;
	...
	$_SESSION['new-mess-info-error'][$rand]['rental_price'] = $rental_price;
	...
	$_SESSION['new-mess-info-error'][$rand]['rental_price_nego'] = $rental_price_nego;
	
	$security_money = $_POST['security-money'];
	$_SESSION['new-mess-info-error'][$rand]['security_money'] = $security_money;
	...
	$_SESSION['new-mess-info-error'][$rand]['security_money_nego'] = $security_money_nego;
	
	$full_address = $_POST['full-address'];
	$_SESSION['new-mess-info-error'][$rand]['full_address'] = $full_address;
	...
	$_SESSION['new-mess-info-error'][$rand]['contact_no'] = $contact_no;
	$contact_no_option = $_POST['contact-no-option'];
	$_SESSION['new-mess-info-error'][$rand]['contact_no_option'] = $contact_no_option;
	...
	$_SESSION['new-mess-info-error'][$rand]['contact_email'] = $contact_email;
	...
	$_SESSION['new-mess-info-error'][$rand]['flat_no'] = $flat_no;
	...
	$floor = $_POST['floor'];
	$_SESSION['new-mess-info-error'][$rand]['floor'] = $floor;
	$_SESSION['new-mess-info-error'][$rand]['floorBengali'] = $floor;
	...
	if($floor != ''){
		...
		if(!preg_match("/^[0-9-]+$/",$floor)){
			...
			$_SESSION['new-mess-info-error'][$rand]['floor'] = $floor - 1;
	...
	$_SESSION['new-mess-info-error'][$rand]['size_of_flat'] = $size_of_flat;
	...
	$_SESSION['new-mess-info-error'][$rand]['size_of_room'] = $size_of_room;
	...
	$_SESSION['new-mess-info-error'][$rand]['number_of_rooms'] = $number_of_rooms;
	...
	$_SESSION['new-mess-info-error'][$rand]['number_of_washrooms'] = $number_of_washrooms;
	...
	$_SESSION['new-mess-info-error'][$rand]['washroom_attached'] = $washroom_attached;
	
	$number_of_balconies = $_POST['number-of-balconies'];
	$_SESSION['new-mess-info-error'][$rand]['number_of_balconies'] = $number_of_balconies;
	...
	$_SESSION['new-mess-info-error'][$rand]['balcony_attached'] = $balcony_attached;
	
	$total_floors = $_POST['total-floor'];
	$_SESSION['new-mess-info-error'][$rand]['total_floors'] = $total_floors;
	$_SESSION['new-mess-info-error'][$rand]['total_floorsBengali'] = $total_floors;
	...
	if($total_floors != ''){
		...
		if(!preg_match("/^[0-9-]+$/",$total_floors)){
			...
			$_SESSION['new-mess-info-error'][$rand]['total_floors'] = $total_floors - 1;
	...
	$_SESSION['new-mess-info-error'][$rand]['lift'] = $lift;
	
	$other_description = $_POST['other-description'];
	$_SESSION['new-mess-info-error'][$rand]['other_description'] = $other_description;
	...
	$_SESSION['new-mess-info'][$rand]['available_from'] = $available_from;
	$_SESSION['new-mess-info'][$rand]['male'] = $male;
	$_SESSION['new-mess-info'][$rand]['female'] = $female;
	$_SESSION['new-mess-info'][$rand]['max_people'] = $max_people;
	$_SESSION['new-mess-info'][$rand]['rental_price'] = $rental_price;
	$_SESSION['new-mess-info'][$rand]['rental_price_nego'] = $rental_price_nego;
	$_SESSION['new-mess-info'][$rand]['security_money'] = $security_money;
	$_SESSION['new-mess-info'][$rand]['security_money_nego'] = $security_money_nego;
	$_SESSION['new-mess-info'][$rand]['full_address'] = $full_address;
	$_SESSION['new-mess-info'][$rand]['contact_no'] = $contact_no;
	$_SESSION['new-mess-info'][$rand]['contact_email'] = $contact_email;
	$_SESSION['new-mess-info'][$rand]['flat_no'] = $flat_no;
	$_SESSION['new-mess-info'][$rand]['floor'] = $_SESSION['new-mess-info-error'][$rand]['floor'];
	$_SESSION['new-mess-info'][$rand]['floorBengali'] = $floor;
	$_SESSION['new-mess-info'][$rand]['size_of_the_flat'] = $size_of_flat;
	$_SESSION['new-mess-info'][$rand]['size_of_the_room'] = $size_of_room;
	$_SESSION['new-mess-info'][$rand]['number_of_rooms'] = $number_of_rooms;
	$_SESSION['new-mess-info'][$rand]['number_of_washrooms'] = $number_of_washrooms;
	$_SESSION['new-mess-info'][$rand]['washroom_attached'] = $washroom_attached;
	$_SESSION['new-mess-info'][$rand]['number_of_balconies'] = $number_of_balconies;
	$_SESSION['new-mess-info'][$rand]['balcony_attached'] = $balcony_attached;
	$_SESSION['new-mess-info'][$rand]['total_floors'] = $_SESSION['new-mess-info-error'][$rand]['total_floors'];
	$_SESSION['new-mess-info'][$rand]['total_floorsBengali'] = $total_floors;
	$_SESSION['new-mess-info'][$rand]['lift'] = $lift;
	$_SESSION['new-mess-info'][$rand]['other_description'] = $other_description;

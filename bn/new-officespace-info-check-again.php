...
if($_SESSION['new-officespace-info'][$rand]['lift'] == 'Yes'){
...
if($_SESSION['new-officespace-info'][$rand]['elevator'] == 'Yes'){
...
if($_SESSION['new-officespace-info'][$rand]['parking_facility'] == 'Yes'){
...
<body onload="startTime()">
	<div class="topnav">
        ...
        <div class="topnav-right">
            ...
            <a href="logout?cbp=new-officespace-info-check-again">লগ আউট</a>
        </div>
    </div>
        	...
        	<tr>
                ...
                <td id="everythingMiddle">
                            ...
                            <td colspan="2" id="adDetailsTableFirstColspan">
                                <table id="adDetailsTableLeft">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($_SESSION['new-officespace-info'][$rand]['rent'] == 1){ echo 'ভাড়া'; }else if($_SESSION['new-officespace-info'][$rand]['sale'] == 1){ echo 'বিক্রয়'; } ?></td>
                                    </tr>
                                    <tr>
                    ...
                    <form action="" method="post">
                        ...
                        <div id="backDiv"><a id="backLink" href="<?php echo $urlBackPage; ?>">অফিস-এর তথ্য এ ফিরে চলুন</a></div>
                    </form>
                </td>

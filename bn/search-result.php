...
<head>
    <meta charset="utf-8">
    <title>কী খুঁজি - অনুসন্ধানের ফলাফল</title>
...
if($content=='flat'){
	...
	$searchContent = 'Flat';
	$searchContentBengali = 'ফ্ল্যাট';
	
}
else if($content=='room'){
	
	$searchContent = 'Room';
	$searchContentBengali = 'রুম';
	
}
else if($content=='mess'){
	
	$searchContent = 'Mess';
	$searchContentBengali = 'মেস';
	
}
else if($content=='officespace'){
	
	$searchContent = 'Office';
	$searchContentBengali = 'অফিস';
	
}
else if($content=='shop'){
	
	$searchContent = 'Shop';
	$searchContentBengali = 'দোকান';
	...
	<div class="topnav">
		...
		if(isset($_SESSION['id'])){
            ...
            <div class="topnav-right">
                ...
                <a href="logout?cbp=search-result">লগ আউট</a>
            </div>
            <?php
			...
			?>
            <div class="topnav-right">
                <a href="login?cbp=search-result">লগ ইন</a>
                <a href="register?cbp=search-result">নিবন্ধন</a>
            </div>
            <?php
                ...
                <td id="LeftColumn">
                    <div id="sideNav">
                        ...
                        <div id="propertiesList">
                          <a href="search-result?content=flat&type=<?php echo $typeShort; ?>&sr=<?php echo $searchRadius; ?>&key=<?php echo $rand; ?>"><div id="propertiesElement"><div id="elementsName">ফ্ল্যাট</div></div></a>
                          <a href="search-result?content=room&type=<?php echo $typeShort; ?>&sr=<?php echo $searchRadius; ?>&key=<?php echo $rand; ?>"><div id="propertiesElement"><div id="elementsName">রুম</div></div></a>
                          <a href="search-result?content=mess&type=<?php echo $typeShort; ?>&sr=<?php echo $searchRadius; ?>&key=<?php echo $rand; ?>"><div id="propertiesElement"><div id="elementsName">মেস</div></div></a>
                          <a href="search-result?content=officespace&type=<?php echo $typeShort; ?>&sr=<?php echo $searchRadius; ?>&key=<?php echo $rand; ?>"><div id="propertiesElement"><div id="elementsName">অফিস</div></div></a>
                          <a href="search-result?content=shop&type=<?php echo $typeShort; ?>&sr=<?php echo $searchRadius; ?>&key=<?php echo $rand; ?>"><div id="propertiesElement"><div id="elementsName">দোকান</div></div></a>
                        </div>
                    </div>
                </td>
                <td id="middleColumn">
                    <table id="InfoAndPhoto">
                        <tr id="headingRow"><td colspan="3"><?php echo $searchContentBengali; ?> এর জন্য অনুসন্ধানের ফলাফল</td></tr>
                        <tr id="currentPlaceRow"><td colspan="3"><div id="currentPlaceDiv"><?php echo $current_place; ?></div><div id="changePlaceDiv"><a id="changePlaceLink" href="<?php echo $urlBackPage; ?>">পরিবর্তন</a></div></td></tr>
                        <tr id="searchRadiusRow">
                        	<td colspan="3">
                            	<span id="searchRadius">অনুসন্ধানের ব্যাসার্ধ <?php echo $searchRadius; ?></span>
                                <?php
								
								if($searchRadius != '0.02'){
									
									?>
									<a id="decrease" href="search-result?content=<?php echo $content; ?>&type=<?php echo $typeShort; ?>&page=<?php echo $pageNum; ?>&sr=<?php echo ($searchRadius - 0.02); ?>&key=<?php echo $rand . $accoTypeChoicePartLink; ?>">হ্রাস</a>
									<?php
								...
								if($searchRadius != '1'){
									...
									?>
									<a id="increase" href="search-result?content=<?php echo $content; ?>&type=<?php echo $typeShort; ?>&page=<?php echo $pageNum; ?>&sr=<?php echo ($searchRadius + 0.02); ?>&key=<?php echo $rand . $accoTypeChoicePartLink; ?>">বৃদ্ধি</a>
									<?php
						...
						?>
                        <tr id="showingResultRow"><td colspan="3"><div id="showingResult"><?php echo $firstResultNumber . '-' . $lastResultNumber ?> নম্বর ফলাফল দেখানো হচ্ছে মোট <?php echo $totalResultNumber ?> টির মধ্য থেকে</div><div id="typeDiv"><a id="typeAllLink" <?php if($type == 'All'){ ?>class="activeTypeAll"<?php } ?> href="search-result?content=<?php echo $content; ?>&sr=<?php echo $searchRadius; ?>&key=<?php echo $rand; ?>">সব</a> <a id="typeRentLink" <?php if($type == 'Rent'){ ?>class="activeTypeRent"<?php } ?> href="search-result?content=<?php echo $content; ?>&type=rt&sr=<?php echo $searchRadius; ?>&key=<?php echo $rand; ?>">ভাড়া</a> <a id="typeSaleLink" <?php if($type == 'Sale'){ ?>class="activeTypeSale"<?php } ?> href="search-result?content=<?php echo $content; ?>&type=sl&sr=<?php echo $searchRadius; ?>&key=<?php echo $rand; ?>">বিক্রয়</a></div></td></tr>
							...
							<tr>
                            	<td colspan="3">
                                	<div id="InfoAndPhotoContainerNothing">
                                    	<div id="nothingDiv">
                                        	দুঃখিত! আমরা আপনার চাহিদা অনুযায়ী কোনো বিজ্ঞাপন খুঁজে পাই নি ।
											<?php
											
                                            if($searchRadius != '1'){ 
                                            
                                                ?>
                                                আপনি অনুসন্ধানের ব্যাসার্ধ বৃদ্ধি করে পুনরায় চেষ্টা করতে পারেন ।
                                                <div id="currentRadius"><span id="searchRadiusInContainer">বর্তমান অনুসন্ধানের ব্যাসার্ধ <?php echo $searchRadius; ?></span>
                                                <?php
                                            ...
                                            <div id="InfoAndPhotoContainer">
                                                <div id="infoDiv">
                                                    ...
                                                    if($rental_price != ''){
                                                        ...
                                                        ?>
                                                        <div id="price"><span id="priceAmount"><?php echo $rental_price; ?> টাকা</span></div>
                                                        <?php
                                                    ...
                                                    <div id="distance">দূরত্ব প্রায় <?php echo $distance ?> কি.মি.</div>
                            ...
                            <tr id="preNextRow">
                                <td id="prePageColumn">
									...
									if($pageNum > 1){
										...
										?>
                                        <button id="previous" onClick="location.href='search-result?content=<?php echo $content; ?>&type=<?php echo $typeShort; ?>&page=<?php echo $pageNum-1; ?>&sr=<?php echo $searchRadius; ?>&key=<?php echo $rand . $accoTypeChoicePartLink; ?>'">আগের পাতা</button>
                                        <?php
                                ...
                                <td id="nextPageColumn">
									...
									if($pageNum < $totalPage){
										...
										?>
                                        <button id="next" onClick="location.href='search-result?content=<?php echo $content; ?>&type=<?php echo $typeShort; ?>&page=<?php echo $pageNum+1; ?>&sr=<?php echo $searchRadius; ?>&key=<?php echo $rand . $accoTypeChoicePartLink; ?>'">পরের পাতা</button>
                                        <?php

...
if(!isset($_SESSION['comebackUrl'])){
	
	if($ip_location == 'Bangladesh'){
		
		$_SESSION['language'] = 'bn';
		
		header('Location:/bn/' . $pathUrl);
		exit;
...
$_SESSION['comebackUrl']['en'] = '/' . $pathUrl;
...
<head>
	<title>Ki Khuji - Buy or rent easily</title>
    <meta charset="utf-8">
            ...
            <tr>
                ...
                <td id="middleColumn">
                    <table id="InfoAndPhoto">
                        <tr id="headingRow"><td colspan="3">All Advertisements</td></tr>
                        <tr id="showingResultRow"><td colspan="3"><span id="showingResult">Showing results <?php echo $firstResultNumber . '-' . $lastResultNumber ?> out of <?php echo $totalResultNumber ?></span></td></tr>
                            ...
                            <td colspan="3">
                                <div id="pageNumContainer">
									...
									if($minPageNum > 6){
										...
										?>
										<button id="page" onClick="location.href='/?page=1'">&laquo;</button>
										<?php
									...
									if($minPageNum > 1){
										...
										?>
										<button id="page" onClick="location.href='/?page=<?php echo $minPageNum-3; ?>'">&lsaquo;</button>
										<?php
									...
									for($k = $minPageNum; $k <= $maxPageNum; $k++){
										...
										?>
										<button id="page" <?php if($pageNum == $k){ ?>class="activePage"<?php } ?> onClick="location.href='/?page=<?php echo $k; ?>'"><?php echo $k; ?></button>
										<?php
									...
									if($maxPageNum < $totalPage){
										...
										?>
										<button id="page" onClick="location.href='/?page=<?php echo $maxPageNum+3; ?>'">&rsaquo;</button>
										<?php
                        ...
                        <tr id="preNextRow">
                            <td id="prePageColumn">
								...
								if($pageNum > 1){
									...
									?>
                                    <button id="previous" onClick="location.href='/?page=<?php echo $pageNum-1; ?>'">Previous page</button>
                                    <?php
                            ...
                            <td id="nextPageColumn">
								...
								if($pageNum < $totalPage){
									...
									?>
                                    <button id="next" onClick="location.href='/?page=<?php echo $pageNum+1; ?>'">Next page</button>
                                    <?php

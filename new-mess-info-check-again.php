...
$_SESSION['comebackUrl']['new-mess-info-check-again'] = $pathUrl;
...
<body onload="startTime()">
	<div class="topnav">
        ...
        <div class="topnav-right">
            ...
            <a href="logout?cbp=new-mess-info-check-again">Log Out</a>
        </div>
    </div>
                ...
                <td id="everythingMiddle">
                    ...
                    <table id="additionalInfoTable">
                            ...
                            <td colspan="2" id="addInfoTableFirstColspan">
                                <table id="addInfoTableLeft">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $_SESSION['new-mess-info'][$rand]['washroom_attached']; ?></td>
                                    </tr>
                                </table>
                            </td>
                            <td colspan="2" id="addInfoTableLastColspan">
                                <table id="addInfoTableRight">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $_SESSION['new-mess-info'][$rand]['balcony_attached']; ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Lift</td>
                                        <td><?php echo $_SESSION['new-mess-info'][$rand]['lift']; ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><div id="otherDescription"><?php echo $_SESSION['new-mess-info'][$rand]['other_description']; ?></div></td>
                        </tr>
                    </table>
					<form action="" method="post">
                    	<div id="submitDiv"><input type="submit" name="submit" id="submit" value="Proceed"></div>
                        <div id="backDiv"><a id="backLink" href="<?php echo $urlBackPage; ?>">Back to New Mess Info</a></div>
                    </form>
                </td>

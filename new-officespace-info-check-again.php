...
$_SESSION['comebackUrl']['new-officespace-info-check-again'] = $pathUrl;
...
<body onload="startTime()">
	<div class="topnav">
        ...
        <div class="topnav-right">
            ...
            <a href="logout?cbp=new-officespace-info-check-again">Log Out</a>
        </div>
    </div>
                ...
                <td id="everythingMiddle">
                            ...
                            <td colspan="2" id="adDetailsTableFirstColspan">
                                <table id="adDetailsTableLeft">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($_SESSION['new-officespace-info'][$rand]['rent'] == 1){ echo 'Rent'; }else if($_SESSION['new-officespace-info'][$rand]['sale'] == 1){ echo 'Sale'; } ?></td>
                                    </tr>
                                    <tr>
                    ...
                    <table id="additionalInfoTable">
                        ...
                        <tr>
                            ...
                            <td colspan="2" id="addInfoTableLastColspan">
                                <table id="addInfoTableRight">
                                    ...
                                    <tr>
                                        <td>Lift</td>
                                        <td><?php echo $_SESSION['new-officespace-info'][$rand]['lift']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Elevator</td>
                                        <td><?php echo $_SESSION['new-officespace-info'][$rand]['elevator']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Parking facility</td>
                                        <td><?php echo $_SESSION['new-officespace-info'][$rand]['parking_facility']; ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><div id="otherDescription"><?php echo $_SESSION['new-officespace-info'][$rand]['other_description']; ?></div></td>
                        </tr>
                    </table>
					<form action="" method="post">
                    	<div id="submitDiv"><input type="submit" name="submit" id="submit" value="Proceed"></div>
                        <div id="backDiv"><a id="backLink" href="<?php echo $urlBackPage; ?>">Back to New Office Info</a></div>
                    </form>
                </td>

...
<body onload="startTime()">
	<div class="topnav">
        ...
        <div class="topnav-right">
            ...
            <a href="logout?cbp=new-room-info-check-again">Log Out</a>
        </div>
    </div>
        	...
        	<tr>
                ...
                <td id="everythingMiddle">
                            ...
                            <td colspan="2" id="addInfoTableFirstColspan">
                                <table id="addInfoTableLeft">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $_SESSION['new-room-info'][$rand]['washroom_attached']; ?></td>
                                    </tr>
                                </table>
                            </td>
                            <td colspan="2" id="addInfoTableLastColspan">
                                <table id="addInfoTableRight">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $_SESSION['new-room-info'][$rand]['balcony_attached']; ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Lift</td>
                                        <td><?php echo $_SESSION['new-room-info'][$rand]['lift']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Parking facility</td>
                                        <td><?php echo $_SESSION['new-room-info'][$rand]['parking_facility']; ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
					...
					<form action="" method="post">
                        ...
                        <div id="backDiv"><a id="backLink" href="<?php echo $urlBackPage; ?>">Back to New Room Info</a></div>
                    </form>
                </td>

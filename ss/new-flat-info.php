...
$urlBackPage = 'index?content=flat';
	...
	<form action="" method="post">
    	<table id="flatInfo">
            ...
            <tr id="availableFor" <?php if($sale == 1){ ?>style="display:none"<?php } ?> >
            	<td>Available for</td> <td><input type="checkbox" onchange="oneChanged()" name="single-male" id="single-male" <?php if($male == 1){ echo 'checked'; } ?> > Single (Male)<br> <input type="checkbox" onchange="oneChanged()" name="single-female" id="single-female" <?php if($female == 1){ echo 'checked'; } ?> > Single (Female) <span id="av-fo" class="sidenote">Check at least one field</span><br> <input type="checkbox" name="family" id="family" <?php if($family == 1){ echo 'checked'; } ?> > Family</td>
            </tr>
            <tr id="messUse" <?php if(($male == 0) && ($female == 0)){ ?>style="display:none"<?php } ?> >
            	<td>Can this flat be used as a mess?</td> <td><input type="radio" onchange="changeMessInfo(this)" name="mess" value="yes" <?php if($mess == 1){ echo 'checked'; } ?> >Yes<br> <input type="radio" onchange="changeMessInfo(this)" name="mess" id="messUseNo" value="no" <?php if($mess == 0){ echo 'checked'; } ?> >No</td>
            </tr>
            <tr id="maxNumPeople" <?php if($mess == 0){ ?>style="display:none"<?php } ?> >
            	<td>Maximum number of people (in case of using as a mess)</td> <td><input type="text" name="max-people-in-mess" <?php if(isset($max_people)){ ?>value="<?php echo $max_people; ?>"<?php } ?> pattern="^[0-9]+"> <span id="mx-ppl" class="sidenote">Use a valid number</span></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td>Full Address</td> <td><textarea name="full-address" placeholder="e.g. House No : 30, Road No : 2/A, Bengali Street, Dhaka, Bangladesh."><?php if(isset($full_address)){ echo $full_address; } ?></textarea> <span id="address" class="sidenote">Use valid characters</span></td>
            </tr>
			<tr>
			...
			<tr>
            	<td>Other description</td> <td><textarea name="other-description" placeholder="e.g. The flat has a beautiful balcony on the south side. One of the washrooms contains commode facility and a bathtub........, etc."><?php if(isset($other_description)){ echo $other_description; } ?></textarea> <span id="oth-des" class="sidenote">Use valid characters</span></td>
            </tr>
            <tr id="submitRow">

...
$urlBackPage = 'index?content=mess';
...
<body>
	<form action="" method="post">
    	<table id="messInfo">
            ...
            <tr id="maxNumPeople">
            	<td>Maximum number of people in the room</td> <td><input type="text" name="max-people-in-mess" <?php if(isset($max_people)){ ?>value="<?php echo $max_people; ?>"<?php } ?> pattern="^[0-9]+"> <span id="mx-ppl" class="sidenote">Use a valid number</span></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td>Security money</td> <td><input type="text" name="security-money" <?php if(isset($security_money)){ ?>value="<?php echo $security_money; ?>"<?php } ?> pattern="^[0-9.]+"> BDT <input type="checkbox" name="security-money-checkbox" id="security-money-checkbox" <?php if($security_money_nego == 1){ echo 'checked'; } ?>>Negotiable <span id="sc" class="sidenote">Enter a valid amount</span></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td>Other description</td> <td><textarea name="other-description" placeholder="e.g. The room is spacious and big enough for four people to stay. It has two big windows........, etc."><?php if(isset($other_description)){ echo $other_description; } ?></textarea> <span id="oth-des" class="sidenote">Use valid characters</span></td>
            </tr>
            <tr id="submitRow">

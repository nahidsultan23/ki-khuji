...
<body>
	<form action="" method="post">
    	<table id="roomInfo">
            ...
            <tr>
            	<td id="firstColumn">Accommodation Type</td><td id="secondColumn">Room<?php
		...
		if($_SESSION['new-room-info'][$rand]['mess'] == 1){
            ...
            <tr id="maxNumPeople" style="display:none">
				...
				if($_SESSION['new-room-info'][$rand]['max_people'] != ''){
					...
					echo $_SESSION['new-room-info'][$rand]['max_people'];
		...
		?>
            ...
            <tr>
				...
				if($_SESSION['new-room-info'][$rand]['rental_price'] != ''){
					
					echo $_SESSION['new-room-info'][$rand]['rental_price'] . ' BDT';
					
					if($_SESSION['new-room-info'][$rand]['rental_price_nego'] == 1){
            ...
            <tr>
				...
				if($_SESSION['new-room-info'][$rand]['security_money'] != ''){
					
					echo $_SESSION['new-room-info'][$rand]['security_money'] . ' BDT';
					
					if($_SESSION['new-room-info'][$rand]['security_money_nego'] == 1){
            ...
            <tr>
            	<td>Full Address</td> <td><?php echo $_SESSION['new-room-info'][$rand]['full_address']; ?></td>
            </tr>
			<tr>
            	<td>Contact no.</td> <td><?php echo $_SESSION['new-room-info'][$rand]['contact_no']; ?></td>
            </tr>
            <tr>
            	<td>Email</td> <td><?php echo $_SESSION['new-room-info'][$rand]['contact_email']; ?></td>
            </tr>
			...
			<tr>
            	<td>Flat no.</td> <td><?php echo $_SESSION['new-room-info'][$rand]['flat_no']; ?></td>
            </tr>
			<tr>
            	<td>Floor</td> <td><?php echo $_SESSION['new-room-info'][$rand]['floor']; ?></td>
            </tr>
			<tr>
            	<td>Size of the flat</td> <td><?php
					
				if($_SESSION['new-room-info'][$rand]['size_of_flat'] != ''){
					
					echo $_SESSION['new-room-info'][$rand]['size_of_flat'] . ' square feet';
            ...
            <tr>
				...
				if($_SESSION['new-room-info'][$rand]['size_of_room'] != ''){
					
					echo $_SESSION['new-room-info'][$rand]['size_of_room'] . ' square feet';
			...
			<tr>
            	<td>Number of rooms in the flat</td> <td><?php echo $_SESSION['new-room-info'][$rand]['number_of_rooms']; ?></td>
            </tr>
			<tr>
            	<td>Number of washrooms in the flat</td> <td><?php echo $_SESSION['new-room-info'][$rand]['number_of_washrooms']; ?></td>
            </tr>
            <tr>
            	<td>Is there any washroom attached to this room?</td> <td><?php echo $_SESSION['new-room-info'][$rand]['washroom_attached']; ?></td>
            </tr>
			<tr>
            	<td>Number of balconies in the flat</td> <td><?php echo $_SESSION['new-room-info'][$rand]['number_of_balconies']; ?></td>
            </tr>
            <tr>
            	<td>Is there any balcony attached to this room?</td> <td><?php echo $_SESSION['new-room-info'][$rand]['balcony_attached']; ?></td>
            </tr>
            <tr>
            	<td>Total number of floors in the house</td> <td><?php echo $_SESSION['new-room-info'][$rand]['total_floors']; ?></td>
            </tr>
            <tr>
            	<td>Is there any lift to reach the flat containing this room?</td> <td><?php echo $_SESSION['new-room-info'][$rand]['lift']; ?></td>
            </tr>
            <tr>
            	<td>Is there any parking facility in the building?</td> <td><?php echo $_SESSION['new-room-info'][$rand]['parking_facility']; ?></td>
            </tr>
			<tr>
            	<td>Other description</td> <td><?php echo $_SESSION['new-room-info'][$rand]['other_description']; ?></td>
            </tr>
            <tr id="submitRow">
            	<td colspan="2"><input type="submit" name="submit" id="submit" value="Proceed"></td>
            </tr>
        	<tr id="backRow"><td colspan="2"><a id="backLink" href="<?php echo $urlBackPage; ?>">Back to New Room Info</a></td></tr>
        </table>
    </form>
...
if(isset($_POST['submit'])){
	...
	if($contact_email == ''){
		...
		if($count){
			...
			$query = "INSERT INTO info(user_id,latitude,longitude,flat,room,mess,officespace,shop,available_from,male,female,family,max_people,rental_price,rental_price_nego,security_money,security_money_nego,full_address,contact_no,contact_email,flat_no,floor,size_of_flat,size_of_room,number_of_rooms,number_of_washrooms,washroom_attached,number_of_balconies,balcony_attached,total_floors,lift,parking_facility,other_description,date,time,timestamp,publish,randomkey) VALUES('$user_ID','$latitude','$longitude','$flat','$room','$mess','$officespace','$shop','$available_from','$male','$female','$family','$max_people','$rental_price','$rental_price_nego','$security_money','$security_money_nego','$full_address','$contact_no','$contact_email','$flat_no','$floor','$size_of_flat','$size_of_room','$number_of_rooms','$number_of_washrooms','$washroom_attached','$number_of_balconies','$balcony_attached','$total_floors','$lift','$parking_facility','$other_description','$date','$time','$timestamp','1','$rand')";
			$result = mysqli_query($dbcInsert,$query);
			
		}
		else{
			
			$query = "INSERT INTO info(user_id,latitude,longitude,flat,room,mess,officespace,shop,available_from,male,female,family,max_people,rental_price,rental_price_nego,security_money,security_money_nego,full_address,contact_no,contact_email,flat_no,floor,size_of_flat,size_of_room,number_of_rooms,number_of_washrooms,washroom_attached,number_of_balconies,balcony_attached,total_floors,lift,parking_facility,other_description,date,time,timestamp,publish,randomkey) VALUES('$contact_email','$latitude','$longitude','$flat','$room','$mess','$officespace','$shop','$available_from','$male','$female','$family','$max_people','$rental_price','$rental_price_nego','$security_money','$security_money_nego','$full_address','$contact_no','$contact_email','$flat_no','$floor','$size_of_flat','$size_of_room','$number_of_rooms','$number_of_washrooms','$washroom_attached','$number_of_balconies','$balcony_attached','$total_floors','$lift','$parking_facility','$other_description','$date','$time','$timestamp','2','$rand')";
			$result = mysqli_query($dbcInsert,$query);

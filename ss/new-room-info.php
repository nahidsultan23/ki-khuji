...
$urlBackPage = 'index?content=room';
	...
	<form action="" method="post">
    	<table id="roomInfo">
            ...
            <tr id="messUse" <?php if(($male == 0) && ($female == 0)){ ?>style="display:none"<?php } ?> >
            	<td>Can this room be used as a mess?</td> <td><input type="radio" onchange="changeMessInfo(this)" name="mess" value="yes" <?php if($mess == 1){ echo 'checked'; } ?> >Yes<br> <input type="radio" onchange="changeMessInfo(this)" name="mess" id="messUseNo" value="no" <?php if($mess == 0){ echo 'checked'; } ?> >No</td>
            </tr>
			...
			<tr>
            	<td>Other description</td> <td><textarea name="other-description" placeholder="e.g. The room is spacious and well ventilated. It has two big windows........, etc."><?php if(isset($other_description)){ echo $other_description; } ?></textarea> <span id="oth-des" class="sidenote">Use valid characters</span></td>
            </tr>
            <tr id="submitRow">

...
$urlBackPage = 'index?content=shop';
...
<body>
	...
	<form action="" method="post">
    	<table id="shopInfo">
            ...
            <tr>
            	<td>Full Address</td> <td><textarea name="full-address" placeholder="e.g. Super Market, Road No : 2/A, Bengali Street, Dhaka, Bangladesh."><?php if(isset($full_address)){ echo $full_address; } ?></textarea> <span id="address" class="sidenote">Use valid characters</span></td>
            </tr>
			<tr>
			...
			<tr>
            	<td>Other description</td> <td><textarea name="other-description" placeholder="e.g. The shop is well decorated and well painted. It is in front of the market........, etc."><?php if(isset($other_description)){ echo $other_description; } ?></textarea> <span id="oth-des" class="sidenote">Use valid characters</span></td>
            </tr>
            <tr id="submitRow">
